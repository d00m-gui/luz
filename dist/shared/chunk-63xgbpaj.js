function n(){return`
    ...
    *,
    ...
    input[type="range"] {
      ...
      &::-moz-range-thumb {
        box-shadow: inset 0 0 0 var(--border-width)
          var(--element-active-border-color);
        height: var(--size-15);
        width: var(--size-15);
        background: var(--element-active-border-color);
        cursor: pointer;
    ...
    body.root.luz-loaded {
      opacity: 0;
      animation: suspense 500ms 200ms cubic-bezier(0.45, 0.05, 0.55, 0.95)
        forwards;
    }
    @keyframes suspense {
      0% {
  ...
  `}function l(i){let{name:r,prefix:e,neutrals:a}={...i.settings};return`
    a {
    ...
    progress {
      background-color: var(--background);
      border: none;
      box-shadow: 0 0 var(--size-1) var(--${e}${r}-500) inset;
      border-radius: var(--border-radius);
      height: var(--size-12);
    }
    [type="checkbox"],
  ...
  `}var c=(i)=>{let{name:r,prefix:e,neutrals:a}={...i.settings},t=`${e}${a}`,o=`${e}${r}`;return`
    ...
    .popup {
      ...
      background-color: var(--${t}-900);
      box-shadow: 0.25rem 0.25rem 0.5ch var(--${o}-950);
