...
const GLYPHNAMES_URL = "https://raw.githubusercontent.com/ryanoasis/nerd-fonts/master/glyphnames.json";
const FONT_ZIP_URL =
  "https://github.com/ryanoasis/nerd-fonts/releases/latest/download/NerdFontsSymbolsOnly.zip";
const TTF_NAME = "SymbolsNerdFont-Regular.ttf";

const CSS_OUT = fileURLToPath(new URL("../src/styles/nerd-icons.generated.css", import.meta.url));
const FONT_OUT = fileURLToPath(new URL("../public/fonts/nerd-icons.woff2", import.meta.url));

const glyphnames: Record<string, { code: string }> = await fetch(GLYPHNAMES_URL).then((r) =>
  r.json(),
);
