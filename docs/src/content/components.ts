...
<div id="menu-basic" popover class="menu">
  ...
  <div class="list-row"><a href="#" style="color: var(--danger)">Delete</a></div>
    ...
    variants: [
      {
        title: "Menú contextual — click derecho",
        html: `<div class="card" style="anchor-name: --ctx-anchor; text-align: center; cursor: context-menu" oncontextmenu="event.preventDefault(); this.nextElementSibling.showPopover()">
  Right-click here
</div>
<div popover id="menu-ctx" class="menu" style="position-anchor: --ctx-anchor">
  ...
  },
  {
    ...
    category: "Overlays",
    covers: ["toast"],
    html: `<button popovertarget="toast" class="success">Show toast</button>
...
<div id="toast-info" popover class="toast info"><i class="icon nf nf-fa-info_circle"></i> New version available</div>`,
    variants: [
      {
        title: "Posición — .top-start / .top-end / .bottom-start",
        html: `<button popovertarget="toast-top-start" class="ghost">top-start</button>
...
<div id="toast-bottom-start" popover class="toast bottom-start"><i class="icon nf nf-fa-bell"></i> Bottom start toast</div>`,
      ...
      {
        title: "Con contenido — reusa .card-title/.card-footer",
        html: `<button popovertarget="toast-content">Show toast with content</button>
<div id="toast-content" popover class="toast info" style="align-items: flex-start; max-width: 22rem">
  ...
  <div>
    ...
    <div class="card-footer" style="display: flex; gap: var(--space-3)">
      ...
      {
        title: "Con acciones",
        html: `<button popovertarget="toast-confirm">Show toast with actions</button>
<div id="toast-confirm" popover class="toast">
  ...
  <button popovertarget="toast-confirm" popovertargetaction="hide" class="danger">Eliminar</button>
      ...
      {
        title: "Stack",
        html: `<div class="toast success" style="position: static; opacity: 1; transform: none">
  <i class="icon nf nf-fa-check_circle"></i> Saved successfully
</div>`,
        preview: `<div class="preview-frame" style="height: auto; overflow: visible; display: flex; flex-direction: column-reverse; align-items: flex-start; gap: var(--space-3); padding: var(--space-4)">
